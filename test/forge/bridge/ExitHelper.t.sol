...
import {CheckpointManager} from "contracts/bridge/CheckpointManager.sol";
...
import "contracts/interfaces/bridge/ICheckpointManager.sol";
import "contracts/interfaces/bridge/IExitHelper.sol";
...
abstract contract Uninitialized is Test {
    ...
    function setUp() public virtual {
        ...
        cmd[0] = "npx";
        cmd[1] = "ts-node";
        cmd[2] = "test/forge/bridge/generateMsgProof.ts";
