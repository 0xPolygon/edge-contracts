...
/**
    ...
    @dev The contract exposes ERC20-like functions that are compatible with the native token, it is *only* intended to be used when the token exists on the root chain, otherwise the contract will require appropriate modifications.
 */
// solhint-disable reason-string
contract NativeERC20 is Context, Initializable, System, IChildERC20 {
