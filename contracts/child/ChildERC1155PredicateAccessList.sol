...
/**
    ...
    @notice Enables ERC1155 token deposits and withdrawals (only from allowlisted addresses, and not from blocklisted addresses) across an arbitrary root chain and child chain
 */
// solhint-disable reason-string
contract ChildERC1155PredicateAccessList is IChildERC1155Predicate, Initializable, System {
